The purpose of the Mobile Engage Testing app is to run semi-automated tests from different location around the globe to ensure it's as fast as we want it to be.
